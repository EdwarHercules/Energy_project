...
public class EstMatDTO {
    ...
    public EstMatDTO(Long id, Estructura estructura, Material material, String unidad, Integer cantidad_mat_34kva, Integer cantidad_mat_18kva, Integer cantidad_mat) {
        this.id = id;
        this.estructura = estructura;
        this.material = material;
        this.unidad = unidad;
